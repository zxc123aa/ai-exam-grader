...
export class StudentsService {
     ...
     * @throws ApiError
     */
    public static readMyLearningAdvice(): CancelablePromise<StudentsReadMyLearningAdviceResponse> {
        return __request(OpenAPI, {
            method: 'GET',
