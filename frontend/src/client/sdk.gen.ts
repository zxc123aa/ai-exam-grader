...
export class ExamsService {
    ...
    /**
     * Upload Client Preprocessed Pages
     ...
     * @throws ApiError
     */
    public static uploadClientPreprocessedPages(data: ExamsUploadClientPreprocessedPagesData): CancelablePromise<ExamsUploadClientPreprocessedPagesResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/exams/{exam_id}/files/{document_id}/upload-preprocessed',
            path: {
                exam_id: data.examId,
                document_id: data.documentId
            },
...
export class StudentsService {
    ...
    /**
     * Read My Knowledge Trends
     * 跨场次的长期趋势：每场发布的总分曲线 + 知识点错误率曲线。
     *
     * 纯 SQL 聚合错题本快照（满分题也建行，分母自带），不调用模型。
     * @returns KnowledgeTrendsPublic Successful Response
     * @throws ApiError
     */
    public static readMyKnowledgeTrends(): CancelablePromise<StudentsReadMyKnowledgeTrendsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/students/me/knowledge-trends'
        });
    }
     ...
     * @throws ApiError
     */
    public static updateMyWrongbookEntry(data: StudentsUpdateMyWrongbookEntryData): CancelablePromise<StudentsUpdateMyWrongbookEntryResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/students/me/wrongbook/entries/{entry_id}',
            path: {
    ...
    /**
     * Read My Learning Advice
     * 基于错题本的针对性学习建议。
     *
     * 暂不缓存——每次请求都重新统计并调用模型生成；若成本或耗时成为问题，
     * 可后续按「统计摘要哈希」加缓存复用结果。
     * @returns LearningAdvicePublic Successful Response
     * @throws ApiError
     */
    public static readMyLearningAdvice(data: StudentsReadMyLearningAdviceData = {}): CancelablePromise<StudentsReadMyLearningAdviceResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/students/me/learning-advice',
            query: {
                exam_id: data.examId
            }
        });
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns PracticeSheetPublic Successful Response
     * @throws ApiError
     */
    public static createMyPracticeSheet(data: StudentsCreateMyPracticeSheetData): CancelablePromise<StudentsCreateMyPracticeSheetResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/students/me/practice-sheets',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
    ...
    /**
     * Read My Practice Sheets
     * @returns PracticeSheetsPublic Successful Response
     * @throws ApiError
     */
    public static readMyPracticeSheets(): CancelablePromise<StudentsReadMyPracticeSheetsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/students/me/practice-sheets'
        });
    ...
    /**
     * Read My Practice Sheet
     * @param data The data for the request.
     * @param data.sheetId
     * @returns PracticeSheetPublic Successful Response
     * @throws ApiError
     */
    public static readMyPracticeSheet(data: StudentsReadMyPracticeSheetData): CancelablePromise<StudentsReadMyPracticeSheetResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/students/me/practice-sheets/{sheet_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static snapQuestion(data: StudentsSnapQuestionData): CancelablePromise<StudentsSnapQuestionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/students/me/snap',
            formData: data.formData,
            mediaType: 'multipart/form-data',
            errors: {
                422: 'Validation Error'
